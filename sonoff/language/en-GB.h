...
// erocm123: Button text for main configuration text
...
// erocm123: Title for Hubitat / SmartThings configuration page
...
// erocm123: Checkbox text for "Configure Other" page
